...
- 별도 AI 리뷰 에이전트 [`sbyoun/vibe-feedback-agent`](https://github.com/sbyoun/vibe-feedback-agent)가 MCP로 public 프로젝트를 읽고 댓글형 피드백을 남긴다.
...
- `POST /api/mcp/projects/{projectId}/claim`: 외부 공개 프로젝트 리뷰의 소유권 이전 요청 생성
